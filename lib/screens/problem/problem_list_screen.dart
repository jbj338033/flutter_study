...
class ProblemSubmitStateConfig {
  final Color color;
  final IconData icon;
  final String label;

  ProblemSubmitStateConfig({
    required this.color,
    required this.icon,
    required this.label,
  });
...
class _ProblemListScreenState extends State<ProblemListScreen> {
  ...
  ProblemSubmitStateConfig _getStateConfig(ProblemSubmitState state) {
    switch (state) {
      case ProblemSubmitState.ACCEPTED:
        return ProblemSubmitStateConfig(
          color: Colors.green,
